                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content card w-100">
                        <div class="modal-body">
                            ...
                            <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/admin/clock/in/" method="POST">
                                @csrf
                            ...
                            @else
                            <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/admin/clock/out/" method="POST">
                                @csrf
                                <div class="col-sm-offset-2 col-sm-12">
