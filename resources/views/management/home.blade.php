...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne12" aria-expanded="true" aria-controls="collapseTwo">
         
          <span>Attendance</span>
        </a>
        <div id="collapseOne12" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Team Attendance:</h6>
            <a class="collapse-item" href="/reporting/team/total">View Team Clocking</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseOne1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/events/total">Open Calender</a>
          </div>
        </div>
      </li>
            ...
            <div class="card border-left-info shadow h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Fibre Opportunities Today</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{$fibre_today->count()}}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Red Heart Opportunities Today</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{$red_today->count()}}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">TMT Opportunities Today</div>
    ...
    <div class="col-xl-6 col-md-6 mb-4">
          <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Fibre Opportunities</div>
        ...
        <div class="col-xl-6 col-md-6 mb-4">
          <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Red Heart Opportunities</div>
            ...
            <div class="col-xl-6 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Open Opportunities</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Not Available</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-xl-6 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Closed Opportunities</div>
                      <div class="h5 mb-0 font-weight-bold text-primary-800">Not Available</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-xl-12 col-lg-7">
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Red Heart Opportunities Overview</h6>
      ...
      <div class="col-xl-12 col-lg-7">
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Fibre Opportunities Overview</h6>
              <div class="dropdown no-arrow">
...
// Area Chart Example
var ctx = document.getElementById("FibreChart");
var myLineChart = new Chart(ctx, {
  type: 'line',
  data: {
    labels: [<?php foreach($fibre as $item){echo json_encode($item->month); echo','; }?>],
    datasets: [{
      label: "Opportunities",
      lineTension: 0.3,
      backgroundColor: "rgba(78, 115, 223, 0.05)",
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [<?php foreach($fibre as $item){echo json_encode($item->data); echo','; }?>],
    }],
  },
  options: {
    maintainAspectRatio: false,
